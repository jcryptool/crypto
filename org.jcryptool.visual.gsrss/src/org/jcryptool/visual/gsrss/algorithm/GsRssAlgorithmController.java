package org.jcryptool.visual.gsrss.algorithm;
...
public class GsRssAlgorithmController {
    ...
    public GsRssAlgorithmController() {
    ...
    public enum KeyType {
        GLRSS_WITH_RSA_AND_BPA("GSRSSwithRSAandBPA");
