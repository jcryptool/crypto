...
public class HEComposite extends Composite {
	...
	private void createHomomorphicArea(final Composite parent) {				
		...
		mainGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 3)); //TODO geändert
		...
		firstOperandGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
		
		Composite subComposite = new Composite(firstOperandGroup, SWT.NONE);
		subComposite.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ...
        initialPlain.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ((GridData)initialPlain.getLayoutData()).heightHint = 50;

        Composite subComposite1 = new Composite(firstOperandGroup, SWT.NONE);
        subComposite1.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ...
        initialEncryptedBits.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
    	...
    	secondOperandGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert

		Composite subComposite2 = new Composite(secondOperandGroup, SWT.NONE);
		subComposite2.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ...
        homomorphPlain.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ((GridData)homomorphPlain.getLayoutData()).heightHint = 50;

        Composite subComposite3 = new Composite(secondOperandGroup, SWT.NONE);
        subComposite3.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ...
        homomorphEncryptedBits.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
		...
		resultGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert

		Composite subComposite4 = new Composite(resultGroup, SWT.NONE);
		subComposite4.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ...
        homomorphResultEncryptedBits.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
		...
		subComposite5.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
        ...
        homomorphResultPlain.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
	...
	private void createPlainArea(final Composite parent) {
		...
		mainGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
		...
		plainOperations.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
		...
		plainResult.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1)); //TODO geändert
