...
public class PreSessionParameter {
    ...
    public PreSessionParameter(SignalProtocolAddress remoteAddress, int deviceId, ParameterInitialization person) {
        ...
        this.identityStore = new InMemoryIdentityKeyStore(person.getIdentityKeyPair(), person.getRegistrationId());
