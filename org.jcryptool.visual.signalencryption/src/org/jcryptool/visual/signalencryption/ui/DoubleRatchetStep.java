...
/**
 * A step in the visualization of the Double Ratchet algorithm containing
 * necessary UI and algorithm updates.
 */
public interface DoubleRatchetStep {
    ...
    /**
     * Advances one step, e.g. when the user clicks the 'next' button. Updates all
     * UI elements of {@code swtParent} accordingly and does necessary algorithm
     * state changes. The method can be overriden to hook additional roll-over
     * logic.
     *
    ...
    /**
     * Goes back one step, e.g. when the user clicks the 'back' button. Updates all
     * UI elements of {@code swtParent} accordingly and does necessary algorithm
     * state changes. The method can be overriden to hook additional roll-over
     * logic.
     *
    ...
    /**
     * Returns the communication entity (Alice/Bob) which should be visible so the
     * user can see the step happening.
     */
    CommunicationEntity shouldShowEntity();

    /**
     * Returns the step's logical index (some steps may be different but share the
     * same index).
     */
    int getStepIndex();

    /**
     * Returns true if the step requires a view-change when going forward (e.g.
     * switching from sender to receiver).
     */
    ...
    /**
     * If the step requires a view-change when going backward (e.g. switching from
     * receiver to sender).
     */
